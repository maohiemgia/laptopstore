...
const getData = () => {
    return fetch(API_URL + "orders").then((response) => {
...
function render(data) {
    ...
    data.data.forEach((item, index) => {
        ...
        <td  scope="col">
            <button class="btn btn-info detail" data-id="${
                item.id
            }">Chi tiết</button>
        </td>
        <td scope="col">
