    ...
    public function run(): void
    {
        DB::table('product_options')->insert([
            ...
            [
                ...
                'gpu' => 'Integrated Intel® Iris® Xe Graphics',
                'ram' => '32 GB LPDDR5-6400MHz (Soldered)',
                'memory' => '1TB SSD M.2 2280 PCIe Gen4 TLC Opal',
                'battery' => '57Whr battery | Rapid Charge (60 minutes = 80% runtime), requires 65W or higher adapter',
                'size' => 'Cao x Rộng x Sâu = 15.53mm x 314.4mm x 222.3mm x / 0.61″ x 12.38″ x 8.75″',
                'weight' => '1.38kg',
                'created_at' => now(),
            ...
            [
                ...
                'discount_value' => 0,
                'screen' => "19inch WUXGA (1920 x 1200), IPS, Anti-Reflective, Touch, 100%sRGB, 400 nits, Narrow Bezel",
                'cpu' => '17th Generation Intel® Core™ i5-1335U Processor (E-cores up to 3.40 GHz P-cores up to 4.60 GHz)',
                'gpu' => 'Integrated Intel® Iris® Xe Graphics',
                'ram' => '16 GB LPDDR5-6400MHz (Soldered)',
                'memory' => '512 GB SSD M.2 2280 PCIe Gen4 TLC Opal',
                'battery' => '57Whr battery | Rapid Charge (60 minutes = 80% runtime), requires 65W or higher adapter',
            ...
            [
                ...
                'discount_value' => 0,
                'screen' => "19inch WUXGA (1920 x 1200), IPS, Anti-Reflective, Touch, 100%sRGB, 400 nits, Narrow Bezel",
                'cpu' => '15th Generation Intel® Core™ i5-1335U Processor (E-cores up to 3.40 GHz P-cores up to 4.60 GHz)',
                'gpu' => 'Integrated Intel® Iris® Xe Graphics',
                'ram' => '8 GB LPDDR5-6400MHz (Soldered)',
                'memory' => '252 GB SSD M.2 2280 PCIe Gen4 TLC Opal',
                'battery' => '57Whr battery | Rapid Charge (60 minutes = 80% runtime), requires 65W or higher adapter',
                'size' => 'Cao x Rộng x Sâu = 15.53mm x 314.4mm x 222.3mm x / 0.61″ x 12.38″ x 8.75″',
                'weight' => '1.38kg',
                'created_at' => now(),
