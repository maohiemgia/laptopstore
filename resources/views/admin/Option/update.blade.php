...
{{-- page title --}}
@section('page_title', 'Cập nhật phiên bản')
...
@section('main-content')
    <div class="container-fluid mt-5 px-2 px-lg-5">
        <h2>Cập nhật phiên bản &#127808;</h2>
        <div class="row mx-auto my-3 d-flex justify-content-between">
            <p class="w-auto">
                Vui lòng nhập theo biểu mẫu bên dưới để cập nhật phiên bản.
            </p>
        </div>
        ...
        <button class="d-inline-block btn btn-primary w-auto mt-4 mb-3" id="back">
