...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="/" class="nav-link text-capitalize">trang chủ</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="/categories" class="nav-link text-capitalize">quản lý danh mục</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="/products" class="nav-link text-capitalize">quản lý sản phẩm</a>
        </li>
    </ul>
    <!-- Right navbar links -->
